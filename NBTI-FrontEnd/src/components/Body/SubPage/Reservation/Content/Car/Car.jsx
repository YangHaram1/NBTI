...
export const Car = ()=>{
    const [events, setEvents] = useState([
        { id: '1', resourceId: 'a', start: '2023-08-05T09:00:00', end: '2023-08-05T10:00:00', title: 'Event 1' },
        { id: '2', resourceId: 'b', start: '2023-08-05T12:00:00', end: '2023-08-05T14:00:00', title: 'Event 2' },
        // Add more initial events here if needed
    ]);
        ...
        <div className={styles.container}>
            <div className='reservationContent'>
                <FullCalendar
                    ...
                    selectable={true} // 시간대를 선택 가능하게 설정
                    selectMirror={true}
                    events={events}
                />
            </div>
