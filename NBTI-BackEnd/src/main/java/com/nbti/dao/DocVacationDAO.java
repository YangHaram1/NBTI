...
//		System.out.println("check : " +dvdto.getVacation_category() +":"+ dvdto.getVacation_start()+":"+dvdto.getStart_half()+":"+dvdto.getStart_half_ap()+":"+dvdto.getEnd_half()+":"+dvdto.getEnd_half_ap()+":"+dvdto.getVacation_end());
